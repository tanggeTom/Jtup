...
def read_json(filename, project):
    ...
    with open(filename, 'r', encoding='utf8') as fp:
        ...
        feature = [add_annotation_line, add_call_line, add_classname_line, add_condition_line, add_field_line,
                   ...
                   cyclomatic_complexity_diff, pre_entropy, last_entropy, modified_code_lines_level,
...
if __name__ == '__main__':
    ...
    rgs = RandomForestClassifier(random_state=0, n_estimators=1000, max_features='sqrt')
